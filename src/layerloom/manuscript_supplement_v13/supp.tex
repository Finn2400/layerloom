...
\title{Supplementary Information for: LayerLoom: Geometry-Encoded Layer Weaving for Color Expansion in Multi-Material FFF Printing}

\author[uh]{Finn Beruldsen}
\ead{fpberuld@uh.edu}

\affiliation[uh]{
  organization={Center for Nuclear Receptors and Cell Signaling, Department of Biology and Biochemistry, University of Houston},
  addressline={3517 Cullen Blvd},
  city={Houston},
  postcode={77204},
  state={TX},
  country={USA}
...
\begin{table}[H]
\centering
\caption{\textbf{Theoretical layer-fraction recipe counts for measured endpoint families.}
Counts collapse redundant stack orderings with identical layer fractions. These values describe the enumerated design space, not the number of experimentally distinguishable printed colors.}
\small
