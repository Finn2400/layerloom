...
# -*- coding: utf-8 -*-
"""
LayerLoom — 3MF GUI (v57 — Rebuilt Source)
------------------------------------------

This file is currently rebuilt from the working v56 source as a stable base so
we can resume v57 development in source form.
"""
        ...
        try:
            if callable(enable_surface):
                enable_surface(
                    ...
                    callback=_picked,
                    left_clicking=True,
                    show_message="Click a convex-hull face to place the model on the plate.",
                    color="#ff8c00",
                    opacity=0.25,
                )
                picker_kind = "surface"
            ...
            _log("INFO", f"[viewer] hull-face picking enabled via {picker_kind}")
        except Exception as e:
